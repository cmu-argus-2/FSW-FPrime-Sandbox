...
#include <project/Components/FirstDeployment/Top/FirstDeploymentTopologyDefs.hpp>
 ...
 *
 * For an explanation of the required type Components::TopologyState see: ComponentsTopologyDefs.hpp.
 *
