...
#include "project/Components/FirstDeployment/Top/FppConstantsAc.hpp"
 ...
 */
namespace PingEntries {
namespace Components_rateGroup_1Hz {
enum { WARN = 3, FATAL = 5 };
}
namespace Components_rateGroup_0_5Hz {
enum { WARN = 3, FATAL = 5 };
}
namespace Components_rateGroup_0_25Hz {
enum { WARN = 3, FATAL = 5 };
}
namespace Components_cmdSeq {
enum { WARN = 3, FATAL = 5 };
}
}  // namespace PingEntries
 ...
 *
 * The topology autocoder requires an object that carries state with the name `Components::TopologyState`. Only the type
