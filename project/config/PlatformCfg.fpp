# =======================================================================
# F Prime platform configuration for the Zephyr RP2350 deployment
# =======================================================================

constant FW_CONSOLE_HANDLE_MAX_SIZE = 24

@ ZephyrTask contains Zephyr's k_thread descriptor. On the RP2350 M33
@ configuration its complete delegate object is 176 bytes.
constant FW_TASK_HANDLE_MAX_SIZE = 176
